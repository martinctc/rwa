...
Following Tonidandel, LeBreton and Johnson (2009), significance is instead
...
variable's weight. A predictor is flagged significant when the **lower bound**
of that difference interval is above zero, meaning it explains meaningfully
more variance than noise would. The test is directional: an interval lying
entirely *below* zero means the predictor performed worse than the random
variable, which is not evidence of importance.
